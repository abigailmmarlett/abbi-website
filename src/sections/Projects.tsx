...
export function Projects() {
  ...
  return (
    <section id="projects" className="relative h-screen flex overflow-hidden"
      style={{
    ...
    >
      ...
      >
        {projects.map((project, index) => (
          <div key={project.id}>
            ...
            {/* Spacing between images (not after last image) */}
            {index < projects.length - 1 && (
              <div className="w-full h-32 bg-gradient-to-b from-transparent via-black/5 to-transparent" />
            )}
          </div>
        ))}
      </div>
      ...
      <div className="w-full lg:w-1/2 bg-black/30 backdrop-blur-sm border-l border-white/10 flex flex-col justify-center p-8 md:p-12 overflow-y-auto relative z-10">
